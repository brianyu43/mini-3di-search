"""Offline M0/M1 entry points. No real-data or filter commands are advertised yet."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="m3di", description="M0/M1 3Di alignment reference")
